...
class XLSXWriter
{
	...
	public function writeSheetHeader($sheet_name, array $header_types, $style=null, $suppress_row = false)
	{
		...
		if (!$suppress_row)
		{
			...
			foreach ($header_row as $c => $v) {
				...
				$cell_style_idx = empty($style) ? $this->addCellStyle( 'GENERAL', $style_string=null ) : $this->addCellStyle( $number_format, json_encode(isset($style[0]) ? $style[$c] : $style) );
